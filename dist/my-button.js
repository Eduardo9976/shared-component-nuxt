import { createElementBlock as i, openBlock as s, createElementVNode as a, toDisplayString as d, defineCustomElement as u } from "vue";
const c = { class: "p-4 bg-gray-200" }, l = {
  __name: "MyButton",
  props: {
...
}, m = u(l), t = document.createElement("style");
t.textContent = `
...
`;
customElements.define("my-button", m);
typeof document < "u" && (document.querySelector("style[data-my-button-styles]") || (t.setAttribute("data-my-button-styles", ""), document.head.appendChild(t)));
